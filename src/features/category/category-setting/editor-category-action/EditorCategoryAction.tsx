...
const EditorCategoryAction: React.FC<EditorCategoryActionProps> = ({children, sub, category}) => {
    ...
    return (
        <>
            ...
            <Modal
                ...
                okButtonProps={{form: "editor-category", htmlType: "submit", loading: loading}}
                okText="Сохранить"
                destroyOnClose
            >
...
export default EditorCategoryAction
